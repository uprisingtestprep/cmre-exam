/* CMRE Exam Simulator, Application Logic */

const ACCESS_CODE  = "CMRE9000";
const EXAM_SECONDS = 17100;
const PASSING_PCT  = 75;
const STORAGE_KEY  = "cmre_exam_state_v1";
const SIM_Q_COUNT  = 220;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"general": "General", "education_and_counselling": "Education and Counselling", "antepartum_care": "Antepartum Care", "intrapartum_care": "Intrapartum Care", "postpartum_care": "Postpartum Care", "newborn_care": "Newborn Care", "well_woman_care": "Well Woman Care", "legal_and_ethical_practice": "Legal and Ethical Practice", "professional_development": "Professional Development"};  // maps domain key -> human-readable label for display
